  ...
  return (
    <main className="container-page grid min-h-[70vh] place-items-center py-10">
      <form onSubmit={submit} className="panel w-full max-w-lg">
        <p className="label text-yellow-300">7-day free trial</p>
        <h1 className="mt-3 text-3xl font-black text-white">Start your business trial</h1>
        <p className="mt-3 text-sm font-semibold leading-relaxed text-zinc-500">
          Create reports for 7 days before paying. No card is required to start.
        </p>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <button className="btn-primary w-full sm:col-span-2" disabled={loading}>{loading ? 'Starting...' : 'Start Free Trial'}</button>
